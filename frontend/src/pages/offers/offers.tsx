...
function OfferCard({
  ...
  return (
    <a
      href={offer.lien}
      className="flex flex-row border border-1 rounded-lg w-5/6 min-h-48 hover:border-black"
    >
      ...
      <div className="flex flex-col justify-between p-5 w-full">
        ...
        <div className="flex justify-between items-center w-full">
          <div className="flex flex-row space-x-3">
            <span className="bg-[#f6f6f6] px-2 rounded-sm">
              {offer.typeOffre}
            </span>
            <span className="bg-[#f6f6f6] px-2 rounded-sm">
              {new Date(offer.dateDebut).toLocaleDateString()}
            </span>
            <span className="bg-[#f6f6f6] px-2 rounded-sm">
              {new Date(offer.dateFin).toLocaleDateString()}
            </span>
          </div>
          <button
        ...
        <div className="flex flex-row justify-between items-center">
          <p className="text-[#7f7f7f]">
            Postée le {new Date(offer.dateDebut).toLocaleDateString()}
          </p>
          <a
            href={offer.lien}
